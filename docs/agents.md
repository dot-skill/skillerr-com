...
Bin: `skill`. Product hosts may wrap the `@skillerr/core` / `@skillerr/runtime` libraries instead of shelling out. Docs: [skillerr.com](https://dot-skill.github.io/skillerr-com/).
